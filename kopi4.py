...
# Menangani outlier dengan flooring dan capping
q_low = data['Produksi_Kopi'].quantile(0.05)
q_hi  = data['Produksi_Kopi'].quantile(0.95)

# Flooring (mengganti nilai di bawah q_low dengan q_low)
data.loc[data['Produksi_Kopi'] < q_low, 'Produksi_Kopi'] = q_low

# Capping (mengganti nilai di atas q_hi dengan q_hi)
data.loc[data['Produksi_Kopi'] > q_hi, 'Produksi_Kopi'] = q_hi
